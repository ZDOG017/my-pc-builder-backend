...
const generateResponse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    Example of the response:
    {
      ...
      "PC case": "NZXT H510"
        ...
        const fetchedProducts = yield Promise.all(requiredComponents.map((key) => __awaiter(void 0, void 0, void 0, function* () {
            const component = components[key];
            try {
                console.log(`Fetching products for component: ${component}`);
                const bestMatchProduct = yield (0, parser_1.fetchProduct)(component);
      ...
      And Also Please ensure that all components are real pc components because before parser could give me freezer or something random`;
            ...
            const adjustmentResult = yield openai.chat.completions.create({
                model: modelId,
                messages: adjustmentMessages,
            });
            const adjustedResponseText = ((_b = adjustmentResult.choices[0].message) === null || _b === void 0 ? void 0 : _b.content) || '';
            ...
            try {
                ...
                const adjustedFetchedProducts = yield Promise.all(Object.entries(adjustedComponents).map((_a) => __awaiter(void 0, [_a], void 0, function* ([key, component]) {
